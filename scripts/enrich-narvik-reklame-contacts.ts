/**
 * Fyll inn telefon og e-post for Narvik reklame og markedsføring (NACE 73, 74.10, …).
 * Ingen SerpAPI — kun Brreg, 1881, Gulesider, nettside og eieroppslag.
 *
 * Kjør: npx tsx scripts/enrich-narvik-reklame-contacts.ts [--shard 0 --shards 6]
 */
...
if (!hasIndustry) forwarded.unshift("--industry", "reklame");
