/**
 * Fyll inn telefon og e-post for Narvik helse og omsorg (NACE 86, 87, 88).
 * Ingen SerpAPI — kun Brreg, 1881, Gulesider, nettside og eieroppslag.
 *
 * Kjør: npx tsx scripts/enrich-narvik-helse-contacts.ts [--shard 0 --shards 10]
 */
...
if (!hasIndustry) forwarded.unshift("--industry", "helse");
